...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setUpViews(int layoutIds[], int dot_on, int dot_off) {
        ...
        mViewPager.setAdapter(new PageFragmentAdapter(activity.getSupportFragmentManager(), fragments));
        mViewPager.addOnPageChangeListener(this);
        addView(mViewPager);
        addView(dot_ll);
    }

    public void setZoomOutPageTransformer(){
        mViewPager.setPageTransformer(true, new ZoomOutPageTransformer());
    }

    public void setDepthPageTransformer(){
